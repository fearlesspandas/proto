...
The function defined within mySim must be a function of type f:dataset[myaxiom] => Double.
In general for sim's holding data of type <datatype>, you would provide a function of type dataset[dependencies] => <datatype>.
...
We also use the 'set' method on the sim's function argument to convert the function provided, which is just of type dataset[myaxiom with otheraxiom] => Double,
to a function of type dataset[myaxiom with otheraxiom] => dataset[multiDependencySim].
